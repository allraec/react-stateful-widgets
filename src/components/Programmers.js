...
export default function Programmers() {
  ...
  let [featuredID, setFeaturedID] = useState();

  const getNameOfFeatured = (programmers, setFeaturedID) => {
    // Leave this for last!
    ...
    let name = programmers[setFeaturedID -1].name;
    return name;
  };
  ...
  return (
    <div className='widget-programmers container'>
      ...
      </div>
      {
        ...
        featuredID
          ? <div style={style}>🎉 Let&apos;s celebrate {getNameOfFeatured(programmers, featuredID)}! 🥳</div>
